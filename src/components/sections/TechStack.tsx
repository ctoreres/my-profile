        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {SKILLS.map((skill, index) => (
            <FadeIn key={skill} delay={index * 100}>
              <div
                className="group h-full relative bg-bg-secondary rounded-2xl p-6 flex items-center justify-center border border-border-subtle/20 hover:border-accent-blue/50 overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-accent-blue/10 cursor-default"
              >
